...
const EmployeeCard = ({ employee, onDelete, onEdit }) => {
  ...
  return (
    <div className="group relative card card-hover overflow-hidden">
      <div className="relative aspect-4/3 w-full overflow-hidden bg-lineat-to-br from-slate-100 to-slate-50">
      ...
      <div className="absolute top-3 left-3 flex gap-2">
        ...
        {employee.isDeleted && (
          <span className="bg-red-500/60 text-white px-2.5 py-1 text-xs rounded">
            DELETED
          </span>
        )}
      </div>
      ...
      {!employee.isDeleted && (
        <div className="absolute inset-0 bg-linear-to-t from-indigo-700/20 via-transparent to-transparant opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6 gap-3">
          <button
